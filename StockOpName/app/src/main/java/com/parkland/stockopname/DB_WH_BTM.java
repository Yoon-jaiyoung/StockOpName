    ...
    public ArrayList<String> getLayout(String fac){
        ...
        try {
            ...
            if (connect == null) {
                ...
                cstmt = connect.prepareStatement("select BUILD_CD from MST_STORAGE where FAC_CD = ? and ST_TYPE = '1' and ST_CLASS = '306' and USE_YN = 'Y' order by ST_ORDER");
                ...
                while (rs.next()) {
                    layout_list.add(rs.getString("BUILD_CD"));
                }
            }
        }catch (Exception ex) {
